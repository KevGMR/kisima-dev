...
const offices = [
	...
	},
	{
		...
		label: "Dubai",
		address:
			"Al Zaroni Building M:05, Near Gold Souk Gate 1, Al Ras, Deira",
	...
	},
	{
		...
		label: "Johannesburg",
		address:
			"Freight City, Unit 4, 597 Innes Road, Jet Park, Johannesburg",
		email: "info@kisimacargo.com",
		mapLink:
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid lg:grid-cols-2 gap-8">
						...
						<div className="space-y-6">
							<div className="bg-accent text-accent-foreground rounded-xl shadow-xl p-8">
